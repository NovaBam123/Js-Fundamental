...
console.log("01.",beasts.indexOf("duck")); //3
console.log("02.",beasts.indexOf("bison", 1));//1
console.log("03.",beasts.indexOf("bison", 2));//4
console.log("04.",beasts.indexOf("duck", 2));//3
console.log("05.",beasts.indexOf("duck", 4));//6
console.log("06.",beasts.indexOf("giraffe"));//-1
